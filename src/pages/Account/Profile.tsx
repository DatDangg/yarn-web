    ...
    return (
        <div className="mb-[24px]">
            <div className="container">
                <div className="text-[24px] font-[600]">My Profile</div>
                <div className="mb-[22px] text-[18px] text-[var(--text-color)]">Manage profile information to secure the account</div>
                        ...
                        <Form className="grid grid-cols-2 md:grid-cols-[300px_1fr] gap-6 items-start">
                            ...
                            <div>
                                ...
                                <div className="flex mt-2 gap-x-8">
                                    <FloatingInputField value="day" label="Day" />
                                    <FloatingInputField value="month" label="Month" />
                                    <FloatingInputField value="year" label="Year" />
