...
const SmoothText: React.FC<any> = ({text}) => {
  ...
  return (
      ...
      <div
        ref={wrapperRef}
        className="relative h-full w-full flex items-end mb-[20px] pb-[20px]"
      >
        <div className="
          ...
          "
        ></div>
        <div className="sticky bottom-[18px] pb-[32px] px-[20px] text-[24px] text-[var(--text-color)]">
